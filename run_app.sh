...
xcodebuild -scheme CountriesSwiftUI -destination "platform=iOS Simulator,id=$SIMULATOR_ID" build || exit 1
...
APP_PATH="$(find /Users/nikfurry/Library/Developer/Xcode/DerivedData -name "CountriesSwiftUI.app" -path "*/Debug-iphonesimulator/*" -type d | head -n 1)"
...
echo "Launching app..."
xcrun simctl launch "$SIMULATOR_ID" "com.swiftui.CountriesSwiftUI" || exit 1
